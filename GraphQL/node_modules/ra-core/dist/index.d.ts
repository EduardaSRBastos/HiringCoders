 ...
 */
declare const useReference: <RecordType extends RaRecord = any>({ reference, id, options, }: UseReferenceProps<RecordType>) => UseReferenceResult<RecordType>;
